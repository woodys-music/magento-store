...
class Ess_M2ePro_Model_Buy_Search_Automatic_Responser
{
    ...
    protected $currentStep = Ess_M2ePro_Model_Buy_Search_Automatic_Requester::STEP_GENERAL_ID;
    ...
    public function processSucceededResponseData($receivedItems)
    {
        ...
        if (count($receivedItems) == 1) {
            ...
            if (!isset($receivedItems[0]['variations'])) {
                ...
                $childListingProduct->setData('general_id_search_status',
                                      Ess_M2ePro_Model_Buy_Listing_Product::GENERAL_ID_SEARCH_STATUS_SET_AUTOMATIC);
