...
class Ess_M2ePro_Model_Buy_Template_Synchronization_RunnerActions
{
                            ...
                            $percentsFrom = 0, $percentsTo = 100)
    {
        if (!is_null($lockItem)) {
            ...
            $lockItem->setStatus(
                Mage::helper('M2ePro')->__('Communication with Rakuten.com is started. Please wait...')
            );
        }
        ...
        if (!is_null($lockItem)) {
            $lockItem->setStatus(
                Mage::helper('M2ePro')->__('Communication with Rakuten.com is finished. Please wait...')
            );
