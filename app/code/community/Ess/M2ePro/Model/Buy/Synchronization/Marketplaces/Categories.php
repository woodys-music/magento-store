    ...
    extends Ess_M2ePro_Model_Buy_Synchronization_Marketplaces_Abstract
{
    ...
    protected function performActions()
    {
        ...
        $this->getActualOperationHistory()->addTimePoint(__METHOD__.'get'.$marketplace->getId(),'Get categories from Rakuten');
    ...
    {
        // ->__('The "Categories" action for Rakuten Marketplace: "%mrk%" has been successfully completed.');
