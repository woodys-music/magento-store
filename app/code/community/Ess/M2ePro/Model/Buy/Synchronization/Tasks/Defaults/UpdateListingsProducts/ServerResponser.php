...
class Ess_M2ePro_Model_Buy_Synchronization_Tasks_Defaults_UpdateListingsProducts_ServerResponser
    extends Ess_M2ePro_Model_Connector_Server_Buy_Inventory_Get_ItemsResponser
{
    ...
    {
        /** @var $tempModel Ess_M2ePro_Model_Buy_Synchronization_Tasks_Defaults_UpdateListingsProducts_Responser */
        $tempModel = Mage::getModel('M2ePro/Buy_Synchronization_Tasks_Defaults_UpdateListingsProducts_Responser');
