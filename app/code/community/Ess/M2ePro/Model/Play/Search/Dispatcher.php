...
class Ess_M2ePro_Model_Play_Search_Dispatcher
{
                              ...
                              Ess_M2ePro_Model_Account $account = NULL)
    {
        ...
        $result = Mage::helper('M2ePro/Data_Global')->getValue('temp_play_manual_search_SKU_result');
        Mage::helper('M2ePro/Data_Global')->unsetValue('temp_play_manual_search_SKU_result');
