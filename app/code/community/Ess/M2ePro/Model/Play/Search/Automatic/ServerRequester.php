...
class Ess_M2ePro_Model_Play_Search_Automatic_ServerRequester
    extends Ess_M2ePro_Model_Connector_Server_Play_Search_Items
{
    /**
     * @var Ess_M2ePro_Model_Play_Search_Automatic_Requester
     */
    ...
    /**
     * @return Ess_M2ePro_Model_Play_Search_Automatic_Requester
     */
    public function getRequesterModel()
    {
        ...
        /** @var $tempModel Ess_M2ePro_Model_Play_Search_Automatic_Requester */
        $this->requesterModel = Mage::getModel('M2ePro/Play_Search_Automatic_Requester');
    ...
    {
        return 'M2ePro/Play_Search_Automatic_ServerResponser';
    }
