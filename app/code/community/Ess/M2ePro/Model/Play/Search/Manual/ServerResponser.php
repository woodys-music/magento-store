...
class Ess_M2ePro_Model_Play_Search_Manual_ServerResponser
    extends Ess_M2ePro_Model_Connector_Server_Play_Search_ItemsResponser
{
    /**
     * @var Ess_M2ePro_Model_Play_Search_Manual_Responser
     */
    ...
    /**
     * @return Ess_M2ePro_Model_Play_Search_Manual_Responser
     */
    public function getResponserModel()
    {
        ...
        /** @var $tempModel Ess_M2ePro_Model_Play_Search_Manual_Responser */
        $this->responserModel = Mage::getModel('M2ePro/Play_Search_Manual_Responser');
