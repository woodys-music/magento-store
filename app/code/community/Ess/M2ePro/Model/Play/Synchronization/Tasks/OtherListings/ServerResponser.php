...
class Ess_M2ePro_Model_Play_Synchronization_Tasks_OtherListings_ServerResponser
    extends Ess_M2ePro_Model_Connector_Server_Play_Inventory_Get_ItemsResponser
{
    ...
    {
        /** @var $tempModel Ess_M2ePro_Model_Play_Synchronization_Tasks_OtherListings_Responser */
        $tempModel = Mage::getModel('M2ePro/Play_Synchronization_Tasks_OtherListings_Responser');
