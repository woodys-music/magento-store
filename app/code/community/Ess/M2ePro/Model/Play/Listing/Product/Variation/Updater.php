...
class Ess_M2ePro_Model_Play_Listing_Product_Variation_Updater
    ...
    public function updateVariations(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        ...
        if ($listingProduct->getMagentoProduct()->isProductWithoutVariations()) {
            ...
            $listingProduct->setData('is_variation_product',
                                     Ess_M2ePro_Model_Play_Listing_Product::IS_VARIATION_PRODUCT_NO)
                           ->save();
        ...
        $listingProduct->setData('is_variation_product',
                                 Ess_M2ePro_Model_Play_Listing_Product::IS_VARIATION_PRODUCT_YES)
                       ->save();
