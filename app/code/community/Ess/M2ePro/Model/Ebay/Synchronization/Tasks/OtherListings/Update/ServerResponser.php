...
class Ess_M2ePro_Model_Ebay_Synchronization_Tasks_OtherListings_Update_ServerResponser
    extends Ess_M2ePro_Model_Connector_Server_Ebay_Inventory_Get_ItemsResponser
{
    // ########################################
