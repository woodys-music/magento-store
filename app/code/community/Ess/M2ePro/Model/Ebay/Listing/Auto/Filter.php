...
class Ess_M2ePro_Model_Ebay_Listing_Auto_Filter extends Ess_M2ePro_Model_Component_Abstract
{
    // ########################################
    ...
    {
        parent::_construct();
        $this->_init('M2ePro/Ebay_Listing_Auto_Filter');
    }
    ...
    {
        Mage::helper('M2ePro/Data_Cache')->removeTagValues('ebay_listing_auto_filter');
        return parent::save();
    }
