...
abstract class Ess_M2ePro_Model_Connector_Server_Play_Responser extends Ess_M2ePro_Model_Connector_Server_Responser
{
    ...
    protected function getObjectByParam($model, $idKey)
    {
        ...
        $this->cachedParamsObjects[$idKey] = Mage::helper('M2ePro/Component_Play')
