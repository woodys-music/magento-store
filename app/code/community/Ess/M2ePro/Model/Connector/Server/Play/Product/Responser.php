...
abstract class Ess_M2ePro_Model_Connector_Server_Play_Product_Responser
    extends Ess_M2ePro_Model_Connector_Server_Play_Responser
{
    ...
    {
        /** @var $inspector Ess_M2ePro_Model_Play_Template_Synchronization_ProductInspector */
        $inspector = Mage::getModel('M2ePro/Play_Template_Synchronization_ProductInspector');
