...
class Ess_M2ePro_Model_Connector_Server_Amazon_Product_Helper
{
    ...
    public function getListRequestData(Ess_M2ePro_Model_Listing_Product $listingProduct, array $params = array())
    {
        ...
        if ($type == self::LIST_TYPE_GENERAL_ID) {
            ...
            $requestData['product_id_type'] = Mage::helper('M2ePro/Component_Amazon_Validation')->isASIN($tempGeneralId) ?
                                              'ASIN' : 'ISBN';
            return $requestData;
        }
        ...
        if ($type == self::LIST_TYPE_WORLDWIDE_ID) {
            ...
            $requestData['product_id_type'] = Mage::helper('M2ePro/Component_Amazon_Validation')->isUPC($tempWorldwideId) ?
                                              'UPC' : 'EAN';
            return $requestData;
        }
                                          ...
                                          array $nativeRequestData = array(), array $params = array())
    {
        ...
        if (!empty($nativeRequestData['product_id']) &&
            ...
            if (in_array($nativeRequestData['product_id_type'],array('ASIN','ISBN'))) {
                ...
                $isIsbnGeneralId = (int)Mage::helper('M2ePro/Component_Amazon_Validation')->isISBN($nativeRequestData['product_id']);
                ...
                $isUpcWorldwideId = (int)Mage::helper('M2ePro/Component_Amazon_Validation')->isUPC($nativeRequestData['product_id']);
