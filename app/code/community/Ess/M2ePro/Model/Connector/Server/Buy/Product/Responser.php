...
abstract class Ess_M2ePro_Model_Connector_Server_Buy_Product_Responser
    extends Ess_M2ePro_Model_Connector_Server_Buy_Responser
{
    ...
    {
        /** @var $inspector Ess_M2ePro_Model_Buy_Template_Synchronization_ProductInspector */
        $inspector = Mage::getModel('M2ePro/Buy_Template_Synchronization_ProductInspector');
