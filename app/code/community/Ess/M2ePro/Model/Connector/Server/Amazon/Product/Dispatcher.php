...
class Ess_M2ePro_Model_Connector_Server_Amazon_Product_Dispatcher
{
    const ACTION_LIST    = 1;
    ...
    {
        $result = Ess_M2ePro_Model_Connector_Server_Amazon_Product_Requester::STATUS_ERROR;
        ...
        switch ($action) {
            case self::ACTION_LIST:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        1000,
                                                        'Ess_M2ePro_Model_Connector_Server_Amazon_Product_List_Multiple',
                                                        $params);
                break;
            ...
            case self::ACTION_RELIST:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        1000,
                                                        'Ess_M2ePro_Model_Connector_Server_Amazon_Product_Relist_Multiple',
                                                        $params);
                break;
            ...
            case self::ACTION_REVISE:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        1000,
                                                        'Ess_M2ePro_Model_Connector_Server_Amazon_Product_Revise_Multiple',
                                                        $params);
                break;
            ...
            case self::ACTION_STOP:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        1000,
                                                        'Ess_M2ePro_Model_Connector_Server_Amazon_Product_Stop_Multiple',
                                                        $params);
                break;
            ...
            case self::ACTION_DELETE:
                $result = $this->processGroupedProducts($sortedProductsData,
                                                        1000,
                                                        'Ess_M2ePro_Model_Connector_Server_Amazon_Product_Delete_Multiple',
                                                        $params);
                break;
            ...
            foreach ($products as $product) {
                ...
                if ($lockItem->isExist()) {
                    if (!isset($params['status_changer']) ||
                        ...
                        // ->__('Listing "%s" locked by other process.');
    ...
    protected function processProducts(array $products, $connectorName, array $params = array())
    {
        try {
            ...
            return Ess_M2ePro_Model_Connector_Server_Amazon_Product_Requester::STATUS_ERROR;
        }
    }
