...
class Ess_M2ePro_Block_Adminhtml_Common_Play_Order_View_Form extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('playOrderViewForm');
        $this->setTemplate('M2ePro/common/play/order.phtml');
        //------------------------------
    ...
    protected function _beforeToHtml()
    {
        ...
        // Shipping data
        // ---------------
        /** @var $shippingAddress Ess_M2ePro_Model_Play_Order_ShippingAddress */
        ...
        $this->setChild('item', $this->getLayout()->createBlock('M2ePro/adminhtml_common_play_order_view_item'));
