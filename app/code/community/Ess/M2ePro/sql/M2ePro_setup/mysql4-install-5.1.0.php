...
INSERT INTO m2epro_config (`group`,`key`,`value`,`notice`,`update_date`,`create_date`) VALUES
  ...
  ('/cron/task/processing/', 'interval', '240', 'in seconds', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
  ...
  ('/cron/task/servicing/', 'interval', '3600', 'in seconds', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
  ('/cron/task/servicing/', 'last_access', NULL, 'date of last access', '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
  ...
  ('/debug/fatal_error/', 'send_to_server', '1', '0 - disable, \r\n1 - enable',
   '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
  ('/documentation/', 'baseurl', 'http://docs.m2epro.com/display/eBayAmazonRakutenMagentoV5/', NULL,
   '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
   ('/video_tutorials/', 'baseurl', 'http://docs.m2epro.com/display/eBayAmazonRakutenMagentoV5/Video+Tutorials', NULL,
   '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
  ...
  ('/logs/cleaning/orders/', 'mode', '1', '0 - disable, \r\n1 - enable', '2013-04-02 00:00:00', '2013-04-02 00:00:00'),
  ('/logs/cleaning/orders/', 'days', '90', 'in days', '2013-04-02 00:00:00', '2013-04-02 00:00:00'),
  ('/logs/cleaning/orders/', 'default', '90', 'in days', '2013-04-02 00:00:00', '2013-04-02 00:00:00'),
...
CREATE TABLE m2epro_amazon_template_new_product (
  ...
  INDEX item_package_quantity_mode (item_package_quantity_mode),
  INDEX number_of_items_mode (number_of_items_mode)
)
ENGINE = INNODB
CHARACTER SET utf8
COLLATE utf8_general_ci;
...
CREATE TABLE m2epro_amazon_template_new_product_description (
  ...
  INDEX title_mode (title_mode),
  INDEX manufacturer_part_number_mode (manufacturer_part_number_mode),
  INDEX search_terms_mode (search_terms_mode),
  INDEX package_weight_mode (package_weight_mode),
  INDEX shipping_weight_mode (shipping_weight_mode),
  INDEX package_weight_unit_of_measure_mode (package_weight_unit_of_measure_mode),
  INDEX shipping_weight_unit_of_measure_mode (shipping_weight_unit_of_measure_mode),
  INDEX target_audience_mode (target_audience_mode)
)
ENGINE = INNODB
CHARACTER SET utf8
COLLATE utf8_general_ci;
...
INSERT INTO `m2epro_config` (`group`,`key`,`value`,`notice`,`update_date`,`create_date`) VALUES
  ...
  ('/buy/synchronization/settings/defaults/update_listings_products/', 'max_deactivate_time', '86400', 'in seconds',
   '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
  ('/buy/synchronization/settings/marketplaces/', 'mode', '1', '0 - disable, \r\n1 - enable',
   '2012-05-21 10:47:49', '2012-05-21 10:47:49'),
...
DROP TABLE IF EXISTS m2epro_play_template_description;
CREATE TABLE m2epro_play_template_description (
  template_description_id INT(11) UNSIGNED NOT NULL,
  PRIMARY KEY (template_description_id)
)
ENGINE = INNODB
...
DROP TABLE IF EXISTS m2epro_play_template_general;
CREATE TABLE m2epro_play_template_general (
  template_general_id INT(11) UNSIGNED NOT NULL,
  sku_mode TINYINT(2) UNSIGNED NOT NULL DEFAULT 0,
  sku_custom_attribute VARCHAR(255) NOT NULL,
