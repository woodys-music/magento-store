...
class Ess_M2ePro_Adminhtml_Common_Play_Template_SynchronizationController
    extends Ess_M2ePro_Controller_Adminhtml_Common_MainController
{
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
            ->_addLeft($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_template_synchronization_edit_tabs'))
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_template_synchronization_edit'))
            ->renderLayout();
    }
