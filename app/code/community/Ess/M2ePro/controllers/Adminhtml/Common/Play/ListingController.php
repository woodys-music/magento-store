    ...
    extends Ess_M2ePro_Controller_Adminhtml_Common_MainController
{
    ...
    protected function _initAction()
    {
        ...
        $this->getLayout()->getBlock('head')
            ...
            ->addJs('M2ePro/Common/Play/Listing/SettingsHandler.js')
    ...
    public function createListingAction()
    {
        ...
        // Add new listing
        //---------------
        $listing = Mage::helper('M2ePro/Component_Play')->getModel('Listing')
            ->addData($sessionData)
            ->save();
        ...
        if ($isEmptyListing == 1) {
            if ($this->getRequest()->getParam('back') == 'list') {
                $backUrl = $this->getUrl('*/adminhtml_common_listing/index', array('tab' => 'play'));
            } else {
    ...
    public function addStepOne()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $temp = array(
                ...
                'template_selling_format_title' => Mage::helper('M2ePro/Component_Play')
                ...
                'template_synchronization_title' => Mage::helper('M2ePro/Component_Play')
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_add_stepOne'))
            ->renderLayout();
    }
    ...
    public function addStepTwo()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $temp = array(
                ...
                'dispatch_to_mode' => $post['dispatch_to_mode'],
                'dispatch_to_value' => $post['dispatch_to_value'],
                'dispatch_to_custom_attribute' => $post['dispatch_to_custom_attribute'],

                'dispatch_from_mode' => $post['dispatch_from_mode'],
                'dispatch_from_value' => $post['dispatch_from_value'],

                'shipping_price_gbr_mode' => $post['shipping_price_gbr_mode'],
                'shipping_price_gbr_value' => $post['shipping_price_gbr_value'],
                'shipping_price_gbr_custom_attribute' => $post['shipping_price_gbr_custom_attribute'],

                'shipping_price_euro_mode' => $post['shipping_price_euro_mode'],
                'shipping_price_euro_value' => $post['shipping_price_euro_value'],
                'shipping_price_euro_custom_attribute' => $post['shipping_price_euro_custom_attribute']
            );
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_add_stepTwo'))
            ->renderLayout();
    }
    ...
    public function addStepThree()
    {
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_add_stepThree'))
            ->renderLayout();
    }
    ...
    public function addStepFour()
    {
        ...
        if ($temp['source_products'] == Ess_M2ePro_Model_Listing::SOURCE_PRODUCTS_CUSTOM) {
            $blockContent = $this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_add_stepFourProduct');
        } else if ($temp['source_products'] == Ess_M2ePro_Model_Listing::SOURCE_PRODUCTS_CATEGORIES) {
            $blockContent = $this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_add_stepFourCategory');
        } else {
            $this->_redirect('*/*/add',array('step'=>'1','clear'=>'yes'));
            return;
        }
        ...
        // Set rule model
        // ---------------------------
        $this->setRuleData('play_rule_add_listing_product');
        // ---------------------------
    ...
    public function addStepFive()
    {
        ...
        // Set rule model
        // ---------------------------
        $this->setRuleData('play_rule_add_listing_product_categories');
        // ---------------------------
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_add_StepFive'))
            ->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $additionalData = array(
            ...
            'dispatch_to_mode' => $model->getDispatchToMode(),
            'dispatch_to_value' => $model->getData('dispatch_to_value'),
            'dispatch_to_custom_attribute' => $model->getData('dispatch_to_custom_attribute'),

            'dispatch_from_mode' => $model->getDispatchFromMode(),
            'dispatch_from_value' => $model->getData('dispatch_from_value'),

            'shipping_price_gbr_mode' => $model->getShippingPriceGbrMode(),
            'shipping_price_gbr_value' => $model->getData('shipping_price_gbr_value'),
            'shipping_price_gbr_custom_attribute' => $model->getData('shipping_price_gbr_custom_attribute'),

            'shipping_price_euro_mode' => $model->getShippingPriceEuroMode(),
            'shipping_price_euro_value' => $model->getData('shipping_price_euro_value'),
            'shipping_price_euro_custom_attribute' => $model->getData('shipping_price_euro_custom_attribute')
        );

        Mage::helper('M2ePro/Data_Global')->setValue('temp_data', array_merge($model->getData(), $additionalData));

        $this->_initAction();
        $this->_addLeft($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_edit_tabs'));
    ...
    public function productAction()
    {
        ...
        $tempData['component_mode'] = Ess_M2ePro_Helper_Component_Play::NICK;
        ...
        // Set rule model
        // ---------------------------
        $this->setRuleData('play_rule_listing_product');
        // ---------------------------
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_product'))
            ->renderLayout();
    }
    ...
    public function categoryProductAction()
    {
        ...
        if (!is_null($addProducts)) {
            ...
            // Set rule model
            // ---------------------------
            $this->setRuleData('play_rule_listing_product_categories');
            // ---------------------------
            ...
            $this->_initAction();
            $this->_addContent($this->getLayout()->createBlock('M2ePro/adminhtml_common_play_listing_product'));
            $this->renderLayout();
        ...
        $listingData['component_mode'] = Ess_M2ePro_Helper_Component_Play::NICK;
        ...
        $blockContent = $this->getLayout()->createBlock(
            'M2ePro/adminhtml_common_play_listing_product_category'
        );
    ...
    public function productGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()
            ->createBlock('M2ePro/adminhtml_common_play_listing_product_grid')->toHtml();
        $this->getResponse()->setBody($response);
    }
    ...
    public function runListProductsAction()
    {
        return $this->getResponse()->setBody(
            $this->processConnector(Ess_M2ePro_Model_Connector_Server_Play_Product_Dispatcher::ACTION_LIST)
        );
    }
    ...
    {
        return $this->getResponse()->setBody(
            $this->processConnector(Ess_M2ePro_Model_Connector_Server_Play_Product_Dispatcher::ACTION_REVISE)
        );
    }
    ...
    {
        return $this->getResponse()->setBody(
            $this->processConnector(Ess_M2ePro_Model_Connector_Server_Play_Product_Dispatcher::ACTION_RELIST)
        );
    }
    ...
    {
        return $this->getResponse()->setBody(
            $this->processConnector(Ess_M2ePro_Model_Connector_Server_Play_Product_Dispatcher::ACTION_STOP)
        );
    }
