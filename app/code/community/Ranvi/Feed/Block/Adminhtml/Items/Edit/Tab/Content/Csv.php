...
class Ranvi_Feed_Block_Adminhtml_Items_Edit_Tab_Content_Csv extends Mage_Adminhtml_Block_Template
{
    ...
    public function getHtmlId()
    {
        if ($this->getData('upload_id')===null) {
            $this->setData('upload_id', 'id_ranvi_feed_upload' );
        }
	...
	public function getFeed(){
		...
		if(Mage::registry('ranvi_feed')){
        	return Mage::registry('ranvi_feed');
        }else{
