    ...
    attribute_sets_confirm: function()
    {
        ...
        if (M2ePro.autoCompleteData.flags.sellingFormatTemplatesDropDown) {
            ...
            $('template_selling_format_id').observe('change', function() {
                AmazonListingSettingsHandlerObj.selling_format_template_id_change();
            });
        } else {
            AmazonListingSettingsHandlerObj.initSellingFormatTemplateAutocomplete();
        }

        AmazonListingSettingsHandlerObj.selling_format_template_id_simulate_change();
