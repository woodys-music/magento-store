...
BuyListingSettingsHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    attribute_sets_confirm: function()
    {
        ...
        if (M2ePro.autoCompleteData.flags.sellingFormatTemplatesDropDown) {
            ...
            $('template_selling_format_id').observe('change', function() {
                BuyListingSettingsHandlerObj.selling_format_template_id_change();
            });
        } else {
            BuyListingSettingsHandlerObj.initSellingFormatTemplateAutocomplete();
        }

        BuyListingSettingsHandlerObj.selling_format_template_id_simulate_change();
    ...
    initSellingFormatTemplateAutocomplete: function()
    {
        ...
        AutoCompleteHandler.bind(
            ...
            BuyListingSettingsHandlerObj.selling_format_template_id_change.bind(BuyListingSettingsHandlerObj)
        );
    ...
    selling_format_template_id_change: function(autoCompleteId)
    {
        ...
        BuyListingSettingsHandlerObj.checkMessages();
    },
    ...
    {
        if (BuyListingSettingsHandlerObj.storeId === null || BuyListingSettingsHandlerObj.marketplaceId === null) {
            return;
        }

        var id = $('template_selling_format_id').value,
            nick = 'selling_format',
            storeId = BuyListingSettingsHandlerObj.storeId,
            marketplaceId = BuyListingSettingsHandlerObj.marketplaceId,
